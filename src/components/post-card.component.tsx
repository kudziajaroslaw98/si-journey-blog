      ...
      <div className="group flex mt-10 flex-col -mx-5 md:mx-3 bg-emperor-100 rounded-md overflow-hidden max-w-[32rem] h-[30rem] transition-all">
        ...
        <div className="p-8">
          <div className="flex flex-col space-y-2">
            ...
            <span className="text-emperor-600 line-clamp-2 pt-2">
              {post.description}
            </span>
          </div>
          ...
          <div className="w-full flex justify-between items-center pt-6">
            <div className="flex items-center space-x-5">
              ...
              <div className="flex flex-col">
                <span className="text-emperor-800">{post.author.name}</span>
            ...
            <span className="hidden sm:flex items-center w-fit cursor-pointer flex-row font-medium relative group/readMore trasition-all">
              <span className="z-20 trasition-all text-picton-blue-500 group-hover/readMore:text-emperor-100 flex justify-center items-center ">
                Read Post
                <ArrowRightIcon className="ml-2 h-4 w-4" />
              </span>

              <span className="z-10 group-hover/readMore:opacity-100 flex -mx-2 -my-1 opacity-0 top-0 absolute -inset-0  bg-picton-blue-500 transition-all rounded-md" />
            </span>
          </div>
        </div>
      </div>

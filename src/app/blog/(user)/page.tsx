...
const Page = async () => {
  ...
  const previewModePath = '/api/draft'
  const exitPreviewModePath = '/api/draft/exit'
  return (
    <>
      <div className="no-scrollbar relative px-4 pb-20 pt-16 sm:px-6 lg:px-8 lg:pb-28 lg:pt-24">

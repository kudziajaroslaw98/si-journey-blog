  ...
  return (
    <div className="space-y-36  overflow-x-clip">
      <div className="xl:max-w-6xl xl:mx-auto relative w-full h-[46.5625rem] flex flex-col justify-center px-12 sm:px-24 xl:px-0">
        ...
        <div className="absolute sm:translate-x-[35%] right-0 top-0 w-full h-full flex flex-row-reverse gap-8 -z-20 ">
          <Image
            src={Image1}
            alt="Background tile"
            className="background-image-common brightness-[.2] sm:brightness-[.4] !h-screen sm:!h-auto"
            priority
          />
            ...
            <div className="flex flex-col w-full h-fit pt-24 lg:pt-0 lg:pl-24 justify-between">
              <div className="space-y-12">
                <div className="flex flex-col text-center lg:text-left">
                  <h2 className="font-bold text-4xl">Jarosław Kudzia</h2>

							...
							<div className='flex flex-col w-full h-fit pt-24 lg:pt-0 lg:pl-24 justify-between'>
								<div className='space-y-12'>
									...
									<p className='font-open-sans leading-normal'>
										As a seasoned programmer and an avid self-improvement advocate, I
										blend my analytical mindset with a passion for personal growth. I
										believe in fostering physical prowess through calisthenics and martial
										arts, while also nurturing the mind and social skills.
										<br />
										<br />
										I strive to make the world a better place by simplifying the journey
										of self-improvement. I aim to make it less overwhelming for those
										starting out, just as I once was, by providing structured, easily
										digestible content.
										<br />
										<br />
					...
					<div className='relative max-w-6xl xl:mx-auto h-[49.3125rem] space-y-24 px-12 sm:px-24 xl:px-0'>
						...
						<div className='space-y-16 text-center flex flex-col items-center font-normal'>
							<p className='text-2xl sm:text-3xl md:text-4xl font-open-sans'>
								We believe that everyone should have <br /> the same possibilities to
